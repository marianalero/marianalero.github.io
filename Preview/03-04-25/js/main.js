;(function () {
	...
	// Set the date we're counting down to
		var countDownDate = new Date("May 24, 2025 16:00:00").getTime();
	...
	function verMesa(){
		window.open("https://mesaderegalos.liverpool.com.mx/milistaderegalos/51626583","_blank")
	...
	function verIglesia(){
		window.open("https://maps.app.goo.gl/Uoda1RBXrE53BBBb7","_blank")
	...
	function verRecepcion(){
		window.open("https://maps.app.goo.gl/p59wNPD3EpUxu7TW9","_blank")
