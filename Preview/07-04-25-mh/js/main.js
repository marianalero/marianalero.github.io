;(function () {
	...
	// Set the date we're counting down to
		var countDownDate = new Date("May 2, 2025 19:00:00").getTime();
	...
	$(function(){
		...
		$("#iralmapa").click(function(){
			window.open("https://maps.app.goo.gl/EfH9kL3YSSMPSfcG6","_blank");
		});

		$("#iraBooking").click(function(){
			window.open("https://www.booking.com/Share-2bNcTK","_blank");
		});
	});
