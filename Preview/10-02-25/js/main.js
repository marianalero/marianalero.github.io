;(function () {
	...
	// Set the date we're counting down to
		var countDownDate = new Date("March 22, 2025 13:00:00").getTime();
	...
	function confirmar(){
		...
		// //https://docs.google.com/forms/d/e/1FAIpQLSfTUJUclHIVc4G-XOYf4ZilIAWLdJRSeqHiCyjf8_PTh5fUqQ/viewform?usp=pp_url&entry.516140191=s&entry.827025270=s&entry.1599079301=s&entry.465259973=s
		// let url = "https://docs.google.com/forms/d/e/1FAIpQLSfTUJUclHIVc4G-XOYf4ZilIAWLdJRSeqHiCyjf8_PTh5fUqQ/formResponse?entry.516140191="+name+"&entry.827025270="+telefono+"&entry.1599079301="+confirmText+"&entry.465259973="+selNumInv+'&submit=Submit';
		// console.log(url);
