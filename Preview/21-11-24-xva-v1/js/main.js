;(function () {
	...
	function confirmar(){
		...
		if(radioValue == "confirm"){
			...
			message+="%20quiero%20confirmar%20mi%20asistencia%20para%20la%20quinceañera%20de%20Ana Victoria%20para%20"+numbertext+". A nombre de "+name;
		}
		else
		{
			message = message+="%20lamentablemente%20no%20podré%20asistir%20a%20la%20quinceañera%20de%Ana Victoria. Mi nombre es "+name;
			
		}

		window.open("https://wa.me/+526624607740/?text="+ message,"_blank");
