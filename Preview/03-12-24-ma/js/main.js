;(function () {
	...
	// Set the date we're counting down to
		var countDownDate = new Date("Dec 21, 2024 18:00:00").getTime();
	...
	function confirmar(){
		...
		if(radioValue == "confirm"){
			...
			message+="%20quiero%20confirmar%20mi%20asistencia%20para%20la%20quinceañera%20de%20Maria José%20para%20"+numbertext+". A nombre de "+name;
		}
		else
		{
			message = message+="%20lamentablemente%20no%20podré%20asistir%20a%20la%20quinceañera%20de%Maria José. Mi nombre es "+name;
			
		}

		window.open("https://wa.me/+526622060042/?text="+ message,"_blank");
	...
	$(function(){
		...
		$("#btnIglesia").click(function(){
			window.location.href="https://maps.app.goo.gl/RnCnekzsGqGNrCj96";
		});

		$("#btnRecepcion").click(function(){
			window.location.href="https://maps.app.goo.gl/9MXWeEMRTdiNajzd6";
		});
