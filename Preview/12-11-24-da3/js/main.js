;(function () {
	...
	// Set the date we're counting down to
		var countDownDate = new Date("December 21, 2024 19:00:00").getTime();
	...
	$(function(){
		...
		$("#btnIglesia").click(function(){
			window.location.href="https://maps.app.goo.gl/hvnQ2h2MJkwdHLjQ7";
		});

		$("#btnRecepcion").click(function(){
			window.location.href="https://maps.app.goo.gl/tdrwEVowx8WWJyXc8";
		});
		
		$("#btnMesaRegalos").click(function(){
			window.location.href="https://mesaderegalos.liverpool.mx/LP/51557596/Dalia_ibeth_-Aaron_de_Jesus_";
		});
	});
