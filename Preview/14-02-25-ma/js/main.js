;(function () {
	...
	// Set the date we're counting down to
		var countDownDate = new Date("February 21, 2025 18:00:00").getTime();
	...
	function confirmar(){
		...
		//https://docs.google.com/forms/d/e/1FAIpQLSeDkAx0v5Yb7caV0zSy-nURm1rCZ0bBFvTK0SPqogNvrJ55mg/viewform?usp=pp_url&entry.516140191=m&entry.827025270=33&entry.1599079301=s&entry.465259973=1
	 	// let url = "https://docs.google.com/forms/d/e/1FAIpQLSeDkAx0v5Yb7caV0zSy-nURm1rCZ0bBFvTK0SPqogNvrJ55mg/formResponse?entry.516140191="+name+"&entry.1599079301="+confirmText+"&entry.465259973="+selNumInv+'&submit=Submit';
		// console.log(url);
	...
	$(function(){
		...
		$("#btnIglesia").click(function(){
			window.open("https://maps.app.goo.gl/KVikvxCfvfhTLc6v9","_blank");
		});

		$("#btnRecepcion").click(function(){
			window.open("https://maps.app.goo.gl/Dn5ka4WhfHBk2jLV8","_blank");
		});
		
		$("#btnMesaRegalos").click(function(){
			window.open("https://mesaderegalos.liverpool.com.mx/milistaderegalos/51484227","_blank");
		});
