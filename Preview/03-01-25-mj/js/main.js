;(function () {
	...
	// Set the date we're counting down to
		var countDownDate = new Date("March 28, 2025 21:00:00").getTime();
	...
	function confirmar(){
		...
		{
				message = message+="%20lamentablemente%20no%20podré%20asistir%20a%20la%20boda%20de%20Mariana%20y%20José.";

		}				
	
		window.open("https://wa.me/+526623006252/?text="+message,"_blank");
	...
	$(function(){
		...
		$("#btnUbicacion").click(function(){
			window.open("https://www.google.com/maps/@28.9603332,-111.0575131,16.75z?entry=ttu&g_ep=EgoyMDI0MTIxMS4wIKXMDSoASAFQAw%3D%3D")
		});
	});
