;(function () {
	...
	// Set the date we're counting down to
		var countDownDate = new Date("April 13, 2024 19:00:00").getTime();
	...
	function confirmar(){
		...
		if(radioValue == "confirm"){
			...
			message+="%20quiero%20confirmar%20mi%20asistencia%20para%20la%20boda%20de%20Itchel%20y%20Juan%20Manuel%20para%20"+numbertext+" A nombre de "+name+",Celular:"+telefono;
		}
		else
		{
			message = message+="%20lamentablemente%20no%20podré%20asistir%20a%20la%20boda%20de%20Itchel%20y%20Juan%20Manuel. Mi nombre es "+name+",Celular:"+telefono;
		}

		window.open("https://wa.me/+526621906655/?text="+ message,"_blank");
