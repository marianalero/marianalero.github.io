;(function () {
	...
	function confirmar(){
		...
		if(radioValue == "confirm"){
			...
			message+="%20quiero%20confirmar%20mi%20asistencia%20para%20la%20quinceañera%20de%20Lesley%20Abigail%20para%20"+numbertext+". A nombre de "+name;
		}
		else
		{
			message = message+="%20lamentablemente%20no%20podré%20asistir%20a%20la%20quinceañera%20de%Lesley%20Abigail. Mi nombre es "+name;
			
		}

		window.open("https://wa.me/+526643108108/?text="+ message,"_blank");
